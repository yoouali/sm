...
<body>
    <div class="container">
        <form class="containerform" action="/examples/actions/confirmation.php" method="post">
            ...
            <div class="form-group row">
                <div class="col-sm-10">
                    <input type="email" class="form-control" id="inputEmailAdress" placeholder="Email Address" required>
                </div>
            </div>
            <div class="form-group row">
                <div class="col-sm-10">
